...
response1 = WS.sendRequest(findTestObject('SOAP-Testing/GetCountryListByName'))
...
println("Global variable value is " + GlobalVariable.CountryISOCode)

WS.sendRequest(findTestObject('SOAP-Testing/GetCapitalfromISOCode'))
